...
import javaclient.client.item.ProviderItemRequestBuilder;
import javaclient.client.listjson.ListJsonRequestBuilder;
import javaclient.client.metricsjson.MetricsJsonRequestBuilder;
import javaclient.client.providersjson.ProvidersJsonRequestBuilder;
import javaclient.client.specs.SpecsRequestBuilder;
/**
...
public class ApiClient extends BaseRequestBuilder {
    ...
    /**
     * Gets an item from the javaclient.client.item collection
