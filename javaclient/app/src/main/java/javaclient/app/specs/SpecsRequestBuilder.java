package javaclient.client.specs;

import com.microsoft.kiota.BaseRequestBuilder;
import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
import javaclient.client.specs.item.WithProviderItemRequestBuilder;
/**
...
public class SpecsRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the javaclient.client.specs.item collection
