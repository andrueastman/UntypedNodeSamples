package javaclient.client.specs.item.item;
...
import javaclient.client.models.API;
import javaclient.client.specs.item.item.item.WithApiJsonItemRequestBuilder;
/**
...
public class ApiJsonItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the javaclient.client.specs.item.item.item collection
